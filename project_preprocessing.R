...
meta_house_DF <- read_csv("/Users/chagwon-u/Desktop/tutorial/static_house_info_387.csv")
...
sample_weather<- read_csv("https://intro-datascience.s3.us-east-2.amazonaws.com/SC-data/weather/2023-weather-data/G4500010.csv")
...
write_csv(data, "df_for_387_only_July_cleaned.csv")
